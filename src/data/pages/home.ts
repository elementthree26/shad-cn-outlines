  ...
  contentThemes: [
    {
      ...
      frequencyTier: "high",
      componentOptions: [
        { name: "Hero with Image Full-Width", wireframeId: "hero-fullwidth-image" },
        { name: "Hero Split Image Right", wireframeId: "hero-split" },
        { name: "Hero Carousel Slider", wireframeId: "hero-carousel" },
        { name: "Hero Animated Interactive", wireframeId: "hero-animated" },
        { name: "Hero Minimal Text", wireframeId: "hero-minimal-text" },
      ],
      considerations: [
    ...
    },
    {
      ...
      frequencyTier: "high",
      componentOptions: [
        { name: "Centered Text Block", wireframeId: "text-centered" },
        { name: "Icon Row Differentiators", wireframeId: "icon-row" },
        { name: "Stats Number Bar", wireframeId: "stats-bar" },
        { name: "Split Section Intro", wireframeId: "text-split-image" },
      ],
      considerations: [
    ...
    },
    {
      ...
      frequencyTier: "high",
      componentOptions: [
        { name: "Card Grid 3x", wireframeId: "card-grid-3" },
        { name: "Icon List Descriptions", wireframeId: "icon-list" },
        { name: "Tab Interface Services", wireframeId: "tab-interface" },
        { name: "Featured Card Spotlight", wireframeId: "card-featured-plus" },
        { name: "Image Cards Hover", wireframeId: "card-image-hover" },
      ],
      considerations: [
    ...
    },
    {
      ...
      frequencyTier: "high",
      componentOptions: [
        { name: "Testimonial Carousel", wireframeId: "testimonial-carousel" },
        { name: "Client Logo Bar", wireframeId: "logo-bar" },
        { name: "Case Study Cards", wireframeId: "card-grid-3" },
        { name: "Star Rating Display", wireframeId: "star-rating" },
        { name: "Video Testimonial", wireframeId: "testimonial-video" },
        { name: "Logos + Quote Combo", wireframeId: "testimonial-quote" },
      ],
      considerations: [
    ...
    },
    {
      ...
      componentOptions: [
        ...
        { name: "CTA Form Embed", wireframeId: "cta-form-embed" },
        { name: "Quote Request Form", wireframeId: "form-quote-request" },
        { name: "CTA Simple Button", wireframeId: "cta-simple" },
      ],
      considerations: [
    ...
    },
    {
      ...
      componentOptions: [
        { name: "Card Grid Recent Posts", wireframeId: "card-grid-3" },
        { name: "Compact List with Dates", wireframeId: "list-compact" },
        { name: "Featured Post + Cards", wireframeId: "card-featured-plus" },
        { name: "Category Tabs Posts", wireframeId: "tab-category" },
      ],
      considerations: [
